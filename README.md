...
- [Proof of Work CAPTCHA](https://github.com/Y0ursTruly/pow_captcha) which uses C compiled to WebAssembly for the work-heavy part
- [JavaScript Timer](https://github.com/Y0ursTruly/timer) has timers that are more precise than the native counterparts _(setInterval, setTimeout)_
- [Maze Generation Library](https://github.com/Y0ursTruly/maze) which builds a perfect maze and can export as an image
- [Homemade Cipher](https://github.com/Y0ursTruly/homemade-cipher) based on matrix multiplication ~~well technically this one was before university but I separated it from the Slate project that I will renovate~~
